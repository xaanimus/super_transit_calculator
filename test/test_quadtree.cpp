...
TEST_CASE("quadtree with nodes") {
    ...
    stop_node nodes[] = {
        stop_node("charlie", 1, "Monday", "Outbound", {12h, 30min},
                  edge_storage(), {0min, nullptr}, miles(10), {0, 3.2}),
        stop_node("delta", 1, "Monday", "Outbound", {12h, 30min},
                  edge_storage(), {0min, nullptr}, miles(10), {2.32, 2.3}),
        stop_node("echo", 1, "Monday", "Outbound", {12h, 30min},
                  edge_storage(), {0min, nullptr}, miles(10), {0.121, 0.1}),
        stop_node("bravo", 1, "Monday", "Outbound", {12h, 30min},
                  edge_storage(), {0min, nullptr}, miles(10), {1, 0}),
        stop_node("alpha", 1, "Monday", "Outbound", {12h, 30min},
